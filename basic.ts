...
class Friends extends Person{
    ...
    constructor (name: string, age: number, jobTitle: string ,country: string ,housepet: string,){
    ...
    // pre zlozity dizajn pouzit vdyz javascriipt 5 ex. tam je to pekne rozdelene pri cars and 
    //cycles 
}
...
for (let index in arr){
    (document.getElementById("here") as HTMLElement).innerHTML  += arr[index].displaY();
